...
{
	// 1. 각 부위별 더미 메쉬를 생성합니다. (CCubeMesh 등을 활용)
	// 실제로는 CTankBaseMesh, CTankTurretMesh 등을 따로 만드시면 좋습니다.
	...
	// 2. 부모를 기준으로 한 초기 위치(Local Matrix) 설정
	m_xmf4x4LocalTurret = Matrix4x4::Translate(0.0f, 2.0f, 0.0f);   // 차체 위쪽에 배치
	m_xmf4x4LocalGun = Matrix4x4::Translate(0.0f, 0.5f, 4.0f);      // 포탑의 앞쪽에 배치
}
